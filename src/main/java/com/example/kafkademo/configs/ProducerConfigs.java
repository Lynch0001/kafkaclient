...
public class ProducerConfigs {
    ...
    @Bean
    public <K, V> ProducerFactory<K, V> createMessageProducerFactory(){
    ...
    @Bean
    public <K, V> KafkaTemplate<K, V> createMessageKafkaTemplate(){
      return new KafkaTemplate<>(createMessageProducerFactory());
    }
  }
